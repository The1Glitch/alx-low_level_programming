...
/**
 * f4 - Finds the biggest ASCII value in the username.
 *
 * @usrn: Username.
 ...
 * @usrn: Username
 * @len: Length of the username.
 * Return: The multiplied ASCII value
 */
...
/**
 * f6 - Generates a random ASCII value based on the username
 *
 * @usrn: Username.
 * Return: A random ASCII value
 */
int f6(char *usrn)
{
	int ch;
